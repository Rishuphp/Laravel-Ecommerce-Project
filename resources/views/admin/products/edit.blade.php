...
<section class="content">
  ...
  <div class="card-body">
    <a href="javascript:void(0)" onclick="deleteImage({{$image->id}})" class="btn btn-danger">Delate</a>
  </div>
</div></div>
                        @endforeach
                        @endif
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="text">SKU (Stock Keeping Unit)</label>
...
<script>
    ...
    $("#productFrom").submit(function(event) {
 ...
 Dropzone.autoDiscover = false;
  ...
  <div class="card-body">
    <a href="javascript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger">Delate</a>
  </div>
</div></div>`;
