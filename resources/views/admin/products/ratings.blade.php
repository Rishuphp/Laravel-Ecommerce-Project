						...
						<div class="card">
							...
							<div class="card-header">
                                    <div class="card-title">
                                        <button type="button" onclick="window.location.href='{{ route("products.productRatings") }}'" class="btn btn-default btn-ms">Reset</button>
                                    </div>
								...
								<table class="table table-hover text-nowrap">
									...
									<tbody>
                                        ...
                                        <tr>
											...
											<td>
                                                @if($rating->status == 1)
                                                <a href="javascript::void(0);" onclick=" (0,'{{$rating->id}}');">
