                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">                                    
                                 ...
                                 <div class="mb-3 col-md-6">                                    
                                    ...
                                    <input value="{{(!empty($address)) ? $address->zip : ''}}" type="text" name="zip" id="zip" placeholder="Enter Your Pincode/Zip" class="form-control">
                                    <p></p>
                                </div>
                                <div class="d-flex">
                                    <button class="btn btn-dark">Update</button>
        ...
        success: function(response){
            if(response.status == true){
                ...
                if(errors.apartment){
                    ...
                    .addClass('is-invalid')
                    .siblings('p')
                    .html(errors.apartment).addClass('invalid-feedback');
                }else{
                    $("#apartment")
                    .removeClass('is-invalid')
                    .siblings('p')
