...
<!-- PWA  -->
<meta name="theme-color" content="#404040ff"/>
...
.top-header .logo a span:first-child {
    color: #fff;
    background-color: #343a40; /* dark */
}

.top-header .logo a span:last-child {
    color: #343a40;
...
<body data-instant-intensity="mousedown">
    ...
    <div class="bg-light top-header"  id="top-header">
        <div class="container">
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="{{route('front.home')}}" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">Prime Shop</span>
